<?php include 'includes/header.php'; ?>
			...
			<h1 class="page-title title-calendar">Calendar</h1>
			
			<div class="page-actions">
				<!-- graphic is just for demo purposes -->
				<img src="img/temp-calendar-butts.png">
			</div>
			
			<section class="content-panel">
				[ Calendar here - No date range title above calendar ]
			</section>
