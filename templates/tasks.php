<?php include 'includes/header.php'; ?>
			...
			<h1 class="page-title title-tasks">Tasks</h1>
				
				<div class="page-actions">
					<a href="#" class="btn btn-labeled btn-primary"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Add task</a>
				</div>
